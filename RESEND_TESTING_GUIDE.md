...
### 2. Current Email Configuration (PRODUCTION READY)
- **From:** `Westprint Website <onboarding@resend.dev>`
- **To:** `estimating@westprint.com` AND `rcarandang@advantageinc.com`
- **Reply-To:** Customer's email from form submission

### 3. Optional: Custom Domain Email
For even better deliverability, you can:
- Verify a custom domain in Resend (e.g., westprint.com)
...
### Email Not Arriving:
1. **Check spam/junk folder** in estimating@westprint.com and rcarandang@advantageinc.com
2. **Verify Resend API key** is valid
3. **Check Resend dashboard** at resend.com for delivery logs
4. **Test email** may take 1-2 minutes to arrive
5. **Both recipients** should receive the email simultaneously
...
3. Verify emails arrive at **both** `estimating@westprint.com` and `rcarandang@advantageinc.com`
4. Test actual forms on homepage and contact page
5. Confirm both recipients receive all quote requests
