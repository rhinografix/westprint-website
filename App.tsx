...
const heroBackgroundImage =
  "https://advantageinc-ca.com/uploads/westprint-bg1.jpg";
...
export default function App() {
    ...
    try {
      const response = await fetch(
        "https://hdcqpvezfqfrieuvtdkv.supabase.co/functions/v1/make-server-a887b54b/send-email",
        {
          ...
          headers: {
            ...
            Authorization:
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhkY3FwdmV6ZnFmcmlldXZ0ZGt2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA3MTQ2MzEsImV4cCI6MjA3NjI5MDYzMX0.66TzzhiOhSyobSqSa1TJpzRwxbwyCk6O1DmDl6R_QrM",
          },
      ...
      if (response.ok && result.success) {
        ...
        toast.error("Failed to send request", {
          description:
            "Please try again or call us at (949) 749-4024",
        });
      }
    } catch (error) {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Customer satisfaction assured",
    },
    {
      icon: Users,
      title: "Personal Service",
      description: "Dedicated one-on-one support",
    },
    {
      icon: Award,
      title: "Since 1981",
    ...
    },
    {
      ...
      description: "30,000+ satisfied clients",
    },
    {
      icon: TrendingUp,
      title: "Fast Turnaround",
      description: "Quick delivery on all projects",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="fade-on-scroll bg-white/20 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-white/30">
                ...
                <p className="text-xl text-[#ffffff] mb-8">
                  Full-color printing, direct mail, and
                  promotional products delivered with
                  exceptional service.
                </p>
                <div className="space-y-3 text-[#ffffff]">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>
                      1600 N Kraemer Blvd, Anaheim, CA 92806
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
                ...
                >
                  ...
                  {submitStatus === "success" && (
                    <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center gap-2">
                      ...
                      <span>
                        Thank you! We'll respond within 24
                        hours.
                      </span>
                    </div>
                  )}
                  ...
                  {submitStatus === "error" && (
                    <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
                      <span>
                        Sorry, there was an error. Please call
                        us at (949) 749-4024.
                      </span>
                    </div>
                  )}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-20 fade-on-scroll">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  Looking for a trusted business printing needs?
                  Look no further than Westprint. Established in
                  1981, our one-stop printing offers outstanding
                  and affordable rates to the Southern
                  California areas. We also provide one-on-one
                  service, online ordering, and marketing
                  solutions designed to help engage and convert
                  more consumers into your customers. Our
                  experienced professionals are always working
                  to find the best solution that fits your
                  needs. Contact Westprint today for a FREE
                  quote.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              ...
              <div className="order-1 lg:order-2 fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Our on-demand digital printing service
                  accommodates your specific timing, quantity,
                  and delivery needs while minimizing waste from
                  outdated materials.
                </p>
                <button
                  onClick={() => setCurrentPage("services")}
                  className="inline-block px-8 py-3 bg-gradient-to-r from-cyan-600 to-teal-600 text-white rounded-lg hover:from-cyan-700 hover:to-teal-700 transition-all"
                >
                  Learn More
                </button>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              <div className="fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Customized direct mail campaigns with
                  cutting-edge technology to efficiently reach
                  your target market with the fastest turnaround
                  times.
                </p>
                <button
                  onClick={() => setCurrentPage("services")}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              ...
              <div className="order-1 lg:order-2 fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Allow us to support your business growth with
                  exemplary design. Let outstanding design
                  convert potential leads into valued clients.
                  The proficient graphic designers at Westprint
                  are fully prepared to collaborate with you on
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              <div className="fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Our comprehensive fulfillment services
                  facilitate efficient data management,
                  personalized printing, streamlined employee
                  workflow, and adherence to budgetary
                  constraints.
                </p>
                <button
                  onClick={() => setCurrentPage("services")}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              ...
              <div className="order-1 lg:order-2 fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  The professionals at Westprint have
                  successfully met a wide range of packaging and
                  label printing needs over the last three
                  decades. We firmly acknowledge that the
                  packaging or label often serves as a client's
                  primary interaction with your company, its
                  offerings, and its products.
                </p>
                <button
                  onClick={() => setCurrentPage("services")}
                  className="inline-block px-8 py-3 bg-gradient-to-r from-cyan-600 to-teal-600 text-white rounded-lg hover:from-cyan-700 hover:to-teal-700 transition-all"
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              <div className="fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Westprint recognizes the significance of
                  upholding your company's image with precision.
                  Our extensive range of banner sizes, shapes,
                  and materials caters to the requirements of
                  one-time promotional signage, banners, and
                  recurring trade show needs.
                </p>
                <button
                  onClick={() => setCurrentPage("services")}
                  className="inline-block px-8 py-3 bg-gradient-to-r from-cyan-600 to-teal-600 text-white rounded-lg hover:from-cyan-700 hover:to-teal-700 transition-all"
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
              ...
              <div className="order-1 lg:order-2 fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  The skilled design team at Westprint can
                  tailor products to highlight your brand. These
                  items can be effectively utilized for
                  promoting your business or as thoughtful
                  gifts.
                </p>
                <button
                  onClick={() => setCurrentPage("services")}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="fade-on-scroll">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  We are pleased to introduce the launch of
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 fade-on-scroll">
              ...
              <p className="text-xl text-gray-600">
                Professional printing solutions for every
                business need
              </p>
            </div>
        ...
        <section
          className="py-20 bg-gradient-to-br from-cyan-600 to-teal-600 text-white"
          id="reviews"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl fade-on-scroll">
                ...
                <p className="text-lg mb-4 leading-relaxed">
                  "The signage you created for this year's
                  Corporate Conference was OUTSTANDING! I gave
                  you this year's Gala theme and you ran with
                  it, with no instruction from me. The quality
                  and creativity exceeded all expectations."
                </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl fade-on-scroll">
                ...
                <p className="text-lg mb-4 leading-relaxed">
                  "I've been using Westprint for decades - same
                  great team I've trusted all these years! Even
                  after moving my business, I still come back
            ...
            <div className="text-center mt-12 fade-on-scroll">
              <button
                ...
                className="inline-block px-8 py-4 bg-white text-cyan-600 rounded-lg hover:bg-gray-100 transition-all"
              >
                Get Started Today
              </button>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="text-gray-300 space-y-2">
                ...
                <a
                  href="mailto:estimating@westprint.com"
